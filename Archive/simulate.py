...
plt.subplot(2, 6, 2)
plt.imshow([group1_filter_time[0, 0,:]], aspect='auto')
plt.title('Time Course of Spatial Map 1')
plt.xlabel('Time')
plt.ylabel('Value')

plt.subplot(2, 6, 3)
plt.imshow([group1_filter_time[0, 1,:]], aspect='auto')
plt.title('Time Course of Spatial Map 1')
plt.xlabel('Time')
plt.ylabel('Value')
...
plt.subplot(2, 6, 4)
plt.imshow([group1_filter_space[0, 0, :]], aspect='auto')
plt.title('Spatial Map 1')
plt.colorbar()

# Plot the spatial map (group1_filter_space)
plt.subplot(2, 6, 5)
plt.imshow([group1_filter_space[0, 1, :]], aspect='auto')
plt.title('Spatial Map 1')
plt.colorbar()
...
# Plot the time course of the spatial map (group1_filter_time)
plt.subplot(2, 6, 8)
plt.imshow([group2_filter_time[0,0,:]], aspect='auto')
plt.title('Time Course of Spatial Map 2')
plt.xlabel('Time')
plt.ylabel('Value')

plt.subplot(2, 6, 9)
plt.imshow([group2_filter_time[0, 1, :]], aspect='auto')
plt.title('Time Course of Spatial Map 2')
plt.xlabel('Time')
plt.ylabel('Value')
...
# Plot the spatial map (group1_filter_space)
plt.subplot(2, 6, 10)
plt.imshow([group2_filter_space[0, 0,:]], aspect='auto')
plt.title('Spatial Map 2')
plt.colorbar()

plt.subplot(2, 6, 11)
plt.imshow([group2_filter_space[0, 1,:]], aspect='auto')
plt.title('Spatial Map 2')
plt.colorbar()
...
ica_components = ica.fit_transform((basis@basisplus@group1_data[0]))
mixer = ica.mixing_
